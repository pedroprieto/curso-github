...
- [[file:presentaciones/sesion-5-presentacion.html][Presentación]]
...
** Entrega de la tarea
Una vez terminada la tarea envíame una notificación a mi usuario de GitHub a través de la organización creada en la sesión 3. No hay que subir ningún archivo en la tarea de la plataforma Moodle del Cefire.
